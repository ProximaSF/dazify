...
insert ignore into urls (url) values
  ...
  -- ('https://www.nytimes.com/games/wordle/index.html'), -- iframe not working on deployment
  -- ('http://radio.garden/'), -- iframe not allowed on deployment
...
INSERT IGNORE INTO url_categories (url_id, category_id) VALUES
    ...
    (@longdoge_id, (SELECT category_id FROM categories WHERE category_name = 'Art'));
...
INSERT IGNORE INTO url_categories (url_id, category_id) VALUES
    ...
    (@worldsdumbestgame_id, (SELECT category_id FROM categories WHERE category_name = 'Game'));
...
INSERT IGNORE INTO url_categories (url_id, category_id) VALUES
    ...
    (@anothersadtrombone_id, (SELECT category_id FROM categories WHERE category_name = 'Sound'));
...
-- 'radio.garden' - not working in iframe on deployment
/* SET @radiogarden_id = (SELECT url_id FROM urls WHERE url = 'http://radio.garden/');
INSERT IGNORE INTO url_categories (url_id, category_id) VALUES  
    (@radiogarden_id, (SELECT category_id FROM categories WHERE category_name = 'Sound')),
    (@radiogarden_id, (SELECT category_id FROM categories WHERE category_name = 'Educational'));
*/
